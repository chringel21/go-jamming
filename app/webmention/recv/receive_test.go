...
func TestReceive(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			json: `{"author":{"name":"Stampeding Longhorn", "picture":"/pictures/Stampeding Longhorn"}, "content":"@wouter The cat pictures are awesome. for jest tests!", "name":"@wouter The cat pictures are awesome. for jest tests!", "published":"2021-03-02T16:17:18+00:00", "source":"https://brainbaking.com/valid-bridgy-source.html", "target":"https://brainbaking.com/valid-indieweb-target.html", "type":"reply", "url":"https://social.linux.pizza/@StampedingLonghorn/105821099684887793"}`,
		},
		{
